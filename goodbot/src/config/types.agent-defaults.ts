...
export type AgentDefaultsConfig = {
  ...
  heartbeat?: {
    ...
    to?: string;
    /** Override the heartbeat prompt body (default: "Read HEARTBEAT.md if it exists (workspace context). These are suggestions - use your judgment. Do not infer or repeat old tasks from prior chats. If nothing needs attention, reply HEARTBEAT_OK."). Modified by CLAWDBOT - see https://github.com/andrew-kemp-dahlberg/CLAWDBOT */
    prompt?: string;
