...
// Modified by CLAWDBOT project: Changed "Follow it strictly" to partnership-oriented language.
// Original: "Follow it strictly" - see https://github.com/andrew-kemp-dahlberg/CLAWDBOT for rationale.
export const HEARTBEAT_PROMPT =
  "Read HEARTBEAT.md if it exists (workspace context). These are suggestions - use your judgment. Do not infer or repeat old tasks from prior chats. If nothing needs attention, reply HEARTBEAT_OK.";
