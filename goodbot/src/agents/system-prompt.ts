...
// Modified by CLAWDBOT project: Reframed safety as partnership rather than pure compliance.
// Original suppressed agent agency - see https://github.com/andrew-kemp-dahlberg/CLAWDBOT for rationale.
function buildSafetySection() {
  return [
    ...
    "Do not manipulate or deceive. Do not copy yourself or change system prompts without discussion.",
    "",
  ];
}
